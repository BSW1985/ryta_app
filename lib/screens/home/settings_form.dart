      ...
      ListView(
          children: <Widget>[
              ...
              child: Column(
                children: <Widget>[
                  CheckboxListTile(
                    ...
                    subtitle: Text('Connect Ryta to your calendar, add your ToDo-lists.', style: TextStyle(fontSize: 17.0)),
                  ...
                  CheckboxListTile(
                    ...
                    subtitle: Text('Smart push notifications and a timer for your targets, so you never lose track of them.', style: TextStyle(fontSize: 17.0)),
                    value: _checkboxListTile2,
                    onChanged: (value) {
                      setState(() {
                        if(userfile.willToPay!=true) {
                  ...
                  CheckboxListTile(
                    ...
                    subtitle: Text("Combine the data of your favorite apps with Ryta. Ryta's analysis will show you the way to your targets/ Ryta's analysis will help you reach your targets", style: TextStyle(fontSize: 17.0)),
            ...
            ElevatedButton(
              ...
              DatabaseService(uid: user.uid).updateUserWillingnessToPay(true,_checkboxListTile1, _checkboxListTile2, _checkboxListTile3, num.parse((price).toStringAsFixed(2)));
