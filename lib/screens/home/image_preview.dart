...
class _ImagePageState extends State<ImagePage> {
  ...
  void initState() {
    ...
    // get the colors
    if (paletteVisualization == true) _getColor();
  }
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned(
              ...
              left: 0.0,
              right: 0.0,
              child: _buildAppBar(user, goal, widget.imageUrl, widget.imageId)),
                    ...
                    child: SizedBox(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            ...
                            fontSize: 30.0,
                            color: _getColorFromHex(goalFontColor)),
